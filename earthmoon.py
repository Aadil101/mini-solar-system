...
TIME_SCALE = 100000         # real seconds per simulation second, the bigger the faster
PIXELS_PER_METER = 3 / 1e7  # distance scale for the simulation, dependant on how big system really is
